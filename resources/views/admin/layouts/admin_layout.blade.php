...
<head>
  ...
  <link href="{{url('admin_assets/plugins/icheck-bootstrap/icheck-bootstrap.min.css')}}" rel="stylesheet">
  <link href="{{url('admin_assets/build/scss/_miscellaneous.scss')}}" rel="stylesheet">
  <link href="{{url('admin_assets/dist/css/custom.css')}}" rel="stylesheet">
