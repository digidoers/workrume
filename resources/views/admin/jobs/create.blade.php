          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Register A New Job </h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="skills" class="form-control" placeholder="Enter Skills" value="{{ old('skills')}}">
                ...
                <div class="form-group">
                    <label class = "require-input">Eligibilty</label>
                    <div class="mb-3">
                    <textarea class="textarea"  name="eligibility" placeholder="Enter Eligibilty"
