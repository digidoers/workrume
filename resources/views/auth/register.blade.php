                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" id="framework_form">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone_no" type="number" class="form-control @error('phone_no') is-invalid @enderror" name="phone_no" required autocomplete="new-password">
                        ...
                        <div class="form-group row">
                            <label for="country" class="col-md-4 col-form-label text-md-right">{{ __('Interest') }}</label>
